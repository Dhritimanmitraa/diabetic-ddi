...
def main():
    ...
    if result.returncode == 0:
        ...
        print(
            "   - python -m scripts.train_twosides_ml --resampling adasyn --sampling-ratio 0.6"
        )
        print(
            "   - python -m scripts.train_twosides_ml --resampling borderline --sampling-ratio 0.5"
        )
