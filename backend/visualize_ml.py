    ...
    try:
        ...
        if db_path.exists():
            ...
            if not df.empty:
                ...
                plt.title(
                    "Drug Interaction Severity Distribution",
                    fontsize=14,
                    fontweight="bold",
                )
    ...
    try:
        ...
        if db_path.exists():
            ...
            if not df.empty:
                ...
                ax.set_title(
                    "ML Model Performance Comparison", fontsize=14, fontweight="bold"
                )
...
def plot_feature_importance(save=True):
    ...
    plt.title(
        "Top Risk Factors for Drug Interactions\nin Diabetic Patients",
        fontsize=14,
        fontweight="bold",
    )
...
def plot_confusion_matrix(save=True):
    ...
    plt.title(
        "Confusion Matrix - Drug Risk Classification", fontsize=14, fontweight="bold"
    )
...
def plot_hybrid_architecture(save=True):
    ...
    # Patient Input
    ax.add_patch(
        plt.Rectangle((3.5, 9), 3, 0.8, facecolor="#9b59b6", edgecolor="black", lw=2)
    )
    ax.text(
        5,
        9.4,
    ...
    ax.add_patch(
        plt.Rectangle(
            (1, 6.5), 8, 1.5, facecolor=rule_color, edgecolor="black", lw=2, alpha=0.9
        )
    )
    ax.text(
        5,
    ...
    ax.text(
        5,
        6.9,
        "Contraindications • Fatal Combos • eGFR Thresholds",
        ha="center",
        va="center",
        fontsize=10,
        color="white",
    ...
    # Arrow with label
    ax.annotate(
        "", xy=(5, 5.7), xytext=(5, 6.5), arrowprops=dict(arrowstyle="->", lw=2)
    )
    ...
    ax.add_patch(
        plt.Rectangle(
            (1, 4), 8, 1.5, facecolor=ml_color, edgecolor="black", lw=2, alpha=0.9
        )
    )
    ax.text(
        5,
    ...
    ax.text(
        5,
        1.9,
        "SHAP Attribution • LLM Explanations (Mistral 7B)",
        ha="center",
        va="center",
        fontsize=10,
        color="white",
    ...
    # Arrow
    ax.annotate(
        "", xy=(5, 0.7), xytext=(5, 1.5), arrowprops=dict(arrowstyle="->", lw=2)
    )

    # Output
    ax.add_patch(
        plt.Rectangle((2, 0), 6, 0.6, facecolor="#34495e", edgecolor="black", lw=2)
    )
    ax.text(
        5,
        0.3,
