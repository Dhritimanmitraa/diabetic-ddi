...
class DiabeticPatient(Base):
    ...
    medications = relationship(
        "DiabeticMedication", back_populates="patient", cascade="all, delete-orphan"
    )
    risk_assessments = relationship(
        "DiabeticDrugRisk", back_populates="patient", cascade="all, delete-orphan"
    )
...
class DiabeticDrugRisk(Base):
    ...
    )  # safe, caution, high_risk, contraindicated, fatal
