...
TRAINING_DRUGS = [
    ...
    "sitagliptin", "linagliptin", "empagliflozin", "canagliflozin", "dapagliflozin",
    "liraglutide", "semaglutide", "dulaglutide", "insulin", "insulin glargine",
    ...
    "amphotericin", "acyclovir", "tenofovir", "cidofovir",
    "cisplatin", "methotrexate", "lithium",
    ...
    "warfarin", "fluconazole", "ciprofloxacin", "levofloxacin",
    "clarithromycin", "trimethoprim", "pentamidine", "quinine",
    # Hepatotoxic
    "acetaminophen", "amiodarone", "valproic acid", "isoniazid",
    # Anticoagulants
    "aspirin", "clopidogrel", "rivaroxaban", "apixaban", "dabigatran",
    # Others
    "gabapentin", "pregabalin", "duloxetine", "tramadol", "morphine",
    "omeprazole", "pantoprazole", "ranitidine", "famotidine",
    "atorvastatin", "rosuvastatin", "simvastatin", "pravastatin",
    "levothyroxine", "allopurinol", "febuxostat",
]
...
PATIENT_PROFILES = [
    # Healthy diabetic - most drugs safe
    {
        ...
        "age": 45,
        "hba1c": 6.8, "fasting_glucose": 120,
        "egfr": 90, "creatinine": 0.9, "potassium": 4.2, "alt": 25, "ast": 22,
        "has_nephropathy": False, "has_retinopathy": False, "has_neuropathy": False,
        "has_cardiovascular": False, "has_hypertension": False,
    },
    # Moderate kidney disease
    {
        ...
        "age": 62,
        "hba1c": 7.5, "fasting_glucose": 150,
        "egfr": 45, "creatinine": 1.6, "potassium": 4.8, "alt": 30, "ast": 28,
        "has_nephropathy": True, "has_retinopathy": False, "has_neuropathy": True,
        "has_cardiovascular": True, "has_hypertension": True,
    },
    # Severe kidney disease - many drugs contraindicated
    {
        ...
        "age": 70,
        "hba1c": 8.2, "fasting_glucose": 180,
        "egfr": 22, "creatinine": 3.0, "potassium": 5.4, "alt": 35, "ast": 32,
        "has_nephropathy": True, "has_retinopathy": True, "has_neuropathy": True,
        "has_cardiovascular": True, "has_hypertension": True,
    },
    # High potassium - hyperkalemia risk
    {
        ...
        "age": 58,
        "hba1c": 7.8, "fasting_glucose": 160,
        "egfr": 55, "creatinine": 1.4, "potassium": 5.8, "alt": 28, "ast": 26,
        "has_nephropathy": True, "has_retinopathy": False, "has_neuropathy": False,
        "has_cardiovascular": True, "has_hypertension": True,
    },
    # Elderly, frail - hypoglycemia risk
    {
        ...
        "age": 82,
        "hba1c": 7.0, "fasting_glucose": 130,
        "egfr": 48, "creatinine": 1.5, "potassium": 4.5, "alt": 22, "ast": 20,
        "has_nephropathy": True, "has_retinopathy": True, "has_neuropathy": True,
        "has_cardiovascular": True, "has_hypertension": True,
    },
    # Type 1, well controlled
    {
        ...
        "years_with_diabetes": 15,
        "age": 35,
        "hba1c": 6.5, "fasting_glucose": 110,
        "egfr": 95, "creatinine": 0.8, "potassium": 4.0, "alt": 20, "ast": 18,
        "has_nephropathy": False, "has_retinopathy": False, "has_neuropathy": False,
        "has_cardiovascular": False, "has_hypertension": False,
    },
    # Liver disease
    {
        ...
        "egfr": 70, "creatinine": 1.1, "potassium": 4.3, "alt": 95, "ast": 88,
        "has_nephropathy": False, "has_retinopathy": False, "has_neuropathy": False,
        "has_cardiovascular": False, "has_hypertension": False,
    },
    # Cardiovascular high risk
    {
        ...
        "age": 68,
        "hba1c": 8.0, "fasting_glucose": 170,
        "egfr": 50, "creatinine": 1.5, "potassium": 4.6, "alt": 30, "ast": 28,
        "has_nephropathy": True, "has_retinopathy": True, "has_neuropathy": True,
        "has_cardiovascular": True, "has_hypertension": True,
    },
]
...
def get_drug_class_features(drug_name: str, rules: DiabeticDrugRules) -> dict:
    ...
    # Check nephrotoxic
    if any(d.lower() in drug_lower or drug_lower in d.lower() for d in rules.NEPHROTOXIC_DRUGS):
        features["is_nephrotoxic"] = 1
    
    # Check hyperkalemia risk
    if any(d.lower() in drug_lower or drug_lower in d.lower() for d in rules.HYPERKALEMIA_RISK_DRUGS):
        features["is_hyperkalemia_risk"] = 1
    
    # Check hepatotoxic
    if any(d.lower() in drug_lower or drug_lower in d.lower() for d in rules.HEPATOTOXIC_DRUGS):
        features["is_hepatotoxic"] = 1
    
    # Check cardioprotective
    if any(d.lower() in drug_lower or drug_lower in d.lower() for d in rules.CARDIOPROTECTIVE_IN_DIABETES):
        features["is_cardioprotective"] = 1
    
    # Check masks hypoglycemia
    if any(d.lower() in drug_lower or drug_lower in d.lower() for d in rules.MASK_HYPOGLYCEMIA):
    ...
    # Diuretics
    diuretics = ["furosemide", "hydrochlorothiazide", "chlorthalidone", "bumetanide", "torsemide", "metolazone"]
    ...
    # SGLT2 inhibitors
    sglt2 = ["gliflozin", "empagliflozin", "canagliflozin", "dapagliflozin", "ertugliflozin"]
...
def prepare_features(df: pd.DataFrame):
    ...
    cat_cols = ["has_nephropathy", "has_cardiovascular", "has_neuropathy", 
                "has_hypertension", "diabetes_type_1"]
    ...
    X = hstack([
        csr_matrix(X_patient),
        csr_matrix(X_cat),
        csr_matrix(X_drug_class),
        X_tfidf
    ])
...
def main():
    ...
    models["Gradient Boosting"] = train_gradient_boosting(X_train.toarray() if hasattr(X_train, 'toarray') else X_train, y_train, class_weights)
