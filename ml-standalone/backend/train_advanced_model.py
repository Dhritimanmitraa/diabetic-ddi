...
def get_interaction_risk_features(classes1: list, classes2: list) -> dict:
    ...
    if (features["has_cyp_inhibitor"] or features["has_cyp_inducer"]) and features[
        "has_narrow_therapeutic"
    ]:
...
def train_advanced_model():
    ...
    model_info = {
        ...
        "model_type": (
            "XGBoost-Advanced" if use_xgboost else "GradientBoosting-Advanced"
        ),
